...
SECRET_KEY = 'django-insecure-5v3hb7yz^b$$=r*d(7o^3rytb#=%q6eh*evqwo49q*hn__9^qd'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Hoang Ngoc Quy",

    "site_header": "Hoang Ngoc Quy",

    "site_brand": "Modern Marketplace",

    "welcome_sign": "Welcome To Hoang Ngoc Quy",

    "copyright": "Hoang Ngoc Quy",

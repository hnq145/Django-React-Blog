...
class AIServiceClientNew:
    def __init__(self):
        print("DEBUG: AIServiceClientNew Initialized - VERSION 5.0 (NEW FILE)")
    ...
    def generate_content(self, prompt: str, type: str, context: str, image_base64: str = None):
        if type == 'text':
            ...
            try:
                # Use Imagen 3.0 (requires Google GenAI SDK)
                print(f"DEBUG: Generating image with prompt: {image_prompt[:50]}...")

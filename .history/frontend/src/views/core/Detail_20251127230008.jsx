...
function Detail() {
  ...
  useEffect(() => {
    if (!post.id) {
      return; // Don't connect if there's no post ID
    }
  ...
  const handleBookmarkPost = async () => {
    ...
    try {
        ...
        Toast("success", response.data.message);
        // The notification will be sent via WebSocket
    } catch (error) {
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <a href="#" className="badge bg-info.bg-gradient mb-2 text-decoration-none">

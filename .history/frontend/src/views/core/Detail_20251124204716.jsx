...
const translations = {
  en: {
    ...
    emailNotPublished: "Your email address will not be published. Required fields are marked *",
    name: "Name *",
    email: "Email *",
  ...
  vi: {
    ...
    views: "Lượt xem",
    comments: "bình luận",
    leaveReply: "Để lại một câu trả lời",
    emailNotPublished: "Địa chỉ email của bạn sẽ không được công bố. Các trường bắt buộc được đánh dấu *",
    name: "Tên *",
    email: "Email *",
          ...
          <div className="row">
            ...
            <div className="col-lg-10 mb-5">
              ...
              <div>
                ...
                <h3>{post?.comments?.length} {t.comments}</h3>
                {post?.comments?.map((c) => (
              ...
              <div className="bg-light p-3 rounded">
                <h3 className="fw-bold">{t.leaveReply}</h3>
                <small>
                  {t.emailNotPublished}
                </small>
                <form
                ...
                >
                  ...
                  <div className="col-12">
                    <label className="form-label">{t.writeComment}</label>
                    <textarea
                      name="comment"
                  ...
                  <div className="col-12">
                    <button type="submit" className="btn btn-primary">
                      {t.postComment} <i className="fas fa-paper-plane"></i>
                    </button>
                  </div>
                </form>
              </div>

            ...
            <div className="col-md-6 col-xxl-4">
              <div className="card border h-100">
                ...
                <div className="card-body p-3">
                  <div className="row">
                    {posts?.map((p) => (
                      <div key={p.id}>               {/* added key wrapper */}
                        <div className="col-12">
                ...
                <div className="card-body p-3">
                  <div className="row">
                    {comments?.slice(0, 3).map((c) => (
                      <div key={c.id}>               {/* added key wrapper */}
                        <div className="col-12">
                  ...
                  <div className="custom-scrollbar h-350">
                    <div className="row">
                      {noti?.slice(0, 3)?.map((n) => (
                        <div key={n.id}>               {/* added key wrapper */}
                          <div className="col-12">
                            <div className="d-flex justify-content-between position-relative">
                              <div className="d-sm-flex">
                                ...
                                <div className="ms-0 ms-sm-3 mt-2 mt-sm-0">
                                  ...
                                  <div className="mb-0">   {/* changed outer p -> div to avoid nested <p> */}
                                    {n.type === "Like" && (
                                      <span>Someone liked your post <b>{n.post?.title?.slice(0, 30) + "..."}</b></span>
                                    )}
                                    {n.type === "Comment" && (
                                      <span>You have a new comment on <b>{n.post?.title?.slice(0, 30) + "..."}</b></span>
                                    )}
                                    {n.type === "Bookmark" && (
                                      <span>Someone bookmarked your post <b>{n.post?.title?.slice(0, 30) + "..."}</b></span>
                                    )}
                                  </div>

...
const translations = {
  en: {
    ...
    useBuilder: "Use the article builder below to edit your article.",
  ...
  vi: {
    editPost: "Chỉnh sửa bài viết trên blog",
    useBuilder: "Sử dụng trình tạo bài viết bên dưới để chỉnh sửa bài viết của bạn.",
    backToPosts: "Quay lại bài viết",
    saveChanges: "Lưu thay đổi",
    basicInfo: "Thông tin cơ bản",
    preview: "Xem trước",
    thumbnail: "Hình bìa nhỏ",
    title: "Tiêu đề",
...
function EditPost() {
  ...
  const handleCreatePost = async (e) => {
    ...
    if (!userId) {
      Toast("error", "User ID is missing. Please make sure you are logged in.");
      setIsLoading(false);
      return;
    }
    ...
    if (
      ...
      Toast(
        "error",
        "Please fill in all required fields (Title, Description, Image, Category, Status)."
      );
      setIsLoading(false);
      return;
    }
                      ...
                      <div className="offset-lg-1 col-lg-10 col-md-12 col-12">
                        <div className="d-lg-flex align-items-center justify-content-between">
                          <div className="mb-4 mb-lg-0">
                            <h1 className="text-white mb-1">{t.editPost}</h1>
                  ...
                  {isLoading === true ? (
                    <>
                      <button
                        ...
                        type="submit"
                      >
                        {t.savingPost} <i className="fas fa-spinner fa-spin"></i>
                      </button>
                    </>
                  ) : (
                    <>
                      <button
                        ...
                        type="submit"
                      >
                        {t.saveChanges} <i className="fas fa-check-circle"></i>
                      </button>
                    </>
                  )}
                </form>

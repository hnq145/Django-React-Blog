...
const AIChatAssistant = ({ contextString }) => {
    ...
    return (
        // ĐÃ CẬP NHẬT: margin: '20px 0' để đẩy sát lề trái và maxWidth: '100%' để mở rộng
        <div style={{ 
            display: 'flex', 
            flexDirection: 'column', 
            width: '100%', 
            
            maxWidth: '100%', // Đảm bảo chiếm toàn bộ chiều rộng của container cha
            
            // THAY ĐỔI QUAN TRỌNG: margin: '20px 0' để loại bỏ căn giữa ngang và căn lề trái
            margin: '20px 0', 
            
            height: '100%', 
            minHeight: '500px', 
            maxHeight: '70vh', // Chiều cao tăng nhẹ

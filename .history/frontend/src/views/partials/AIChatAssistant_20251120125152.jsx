            ...
            <form onSubmit={handleSubmit} className="p-2 border-t bg-gray-50 rounded-b-lg">
                ...
                <div className="flex items-center gap-2 w-full">
                    <input
                        ...
                        // Giữ nguyên flex-1 và min-w-0, nhưng logic w-full ở cha sẽ giúp nó hoạt động đúng
                        className="flex-1 min-w-0 p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                        disabled={isLoading}
                    />
                    <button
                        type="submit"
                        // Thêm shrink-0 để nút không bị bóp méo và giúp tính toán width chuẩn hơn

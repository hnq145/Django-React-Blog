                    ...
                    >
                        <div 
                            style={{
                                ...
                                // Xử lý văn bản
                                whiteSpace: 'pre-wrap', // Giữ xuống dòng chuẩn
            ...
            <div style={{ padding: '12px', borderTop: '1px solid #f3f4f6', backgroundColor: '#f9fafb', flexShrink: 0 }}>
                <form 
                    ...
                    style={{ 
                        ...
                        width: '100%', 
                        backgroundColor: 'white',
                        border: '1px solid #e5e7eb', // Viền xám nhẹ bên ngoài
                        borderRadius: '9999px', // Hình viên thuốc
                ...
                >
                    ...
                    <button
                        ...
                        style={{
                            ...
                            border: 'none',
                            borderRadius: '50%',
                            // Màu xanh khi có chữ, xám khi trống

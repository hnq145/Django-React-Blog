...
function AISummary({ postId, postTitle }) {
    ...
    return (
        <div className="ai-summary-container my-6 p-1 border-l-4 border-blue-300 rounded-sm shadow-lg bg-white">
            ...
            {!summary && !isLoading && (
                <button
                    ...
                    disabled={isLoading}
                >
                    {isLoading ? 'Analyzing...' : 'Quick support of this article ✨'}
                </button>
            )}
            ...
            {summary && (
                <div className="mt-4">
                    <h5 className="font-semibold text-lg border-b pb-1 mb-2 text-gray-800">Result:</h5>

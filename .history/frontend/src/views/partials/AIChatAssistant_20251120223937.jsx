        ...
        <div className="flex flex-col h-full border rounded-lg shadow-lg bg-white w-full max-w-2xl mx-auto min-h-[400px] max-h-[80vh] overflow-hidden box-border">
            ...
            >
                <input
                    ...
                    className="flex-1 block gap-1 w-full min-w-0 p-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 box-border"
                    disabled={isLoading}
                />
                <button
                    type="submit"

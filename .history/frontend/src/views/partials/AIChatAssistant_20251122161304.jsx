...
// import { useAIService } from '../../utils/useAIService'; // Giả định hook này đã được định nghĩa và có thể sử dụng
...
const useAIService = () => {
    ...
    const generateContent = async (prompt, type) => {
        ...
        if (type === 'image') {
            // Placeholder for image data (a very small transparent GIF)
...
const AIChatAssistant = ({ contextString }) => {
    // Lưu ý: Đảm bảo component của bạn có thể truy cập hook useAIService
    ...
    return (
        // ĐÃ CẬP NHẬT: margin: '20px auto' -> margin: '20px 0' VÀ maxWidth: '500px' -> '100%' VÀ maxHeight: '50vh' -> '70vh'
        <div style={{ 
            display: 'flex', 
            flexDirection: 'column', 
            width: '100%', 
            maxWidth: '100%', // Đảm bảo chiếm toàn bộ chiều rộng của container
            margin: '20px 0', // Loại bỏ căn giữa ngang, chỉ giữ margin trên và dưới
            height: '100%', 
            minHeight: '500px', 
            maxHeight: '70vh', // Chiều cao tối đa lớn hơn

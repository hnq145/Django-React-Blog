...
const AIChatAssistant = ({ contextString }) => {
    ...
    return (
        <div className="flex flex-col h-screen border rounded-lg shadow-lg bg-white" style={{ maxHeight: '600px' }}>
            {/* Header */}
            <div className="p-4 border-b bg-gray-50 rounded-t-lg">
                <h3 className="font-semibold text-lg text-gray-800">Contextual AI Assistant 🤖</h3>
                <p className="text-sm text-gray-500">
                    AI has read the context. Make requests!
                </p>
            </div>
            ...
            <div className="flex-grow p-4 overflow-y-auto space-y-4 bg-gray-100">
                {messages.length === 0 && (
                    <p className="text-center text-gray-500 text-sm p-4">
                        Enter request (For example: "Summarize content", "Catch spelling mistakes", or "Create an avatar of a programmer coding").
                    </p>
                )}

...
# SỬA LỖI: Đảm bảo 'ContentGenerateView' đã được import
...
    path('post/bookmark-post/', api_views.BookmarkPostAPIView.as_view(), name='bookmark_post'),
    ...
    # SỬA LỖI 404: Xóa bỏ 'v-' ở đây
    # Đường dẫn này phải khớp với 'useAIService.js' (Turn 40)
...
    path('author/dashboard/comment-list/<int:user_id>/', api_views.DashboardCommentLists.as_view(), name='dashboard_comment_list'),
    path('author/dashboard/noti-list/<int:user_id>/', api_views.DashboardNotificationList.as_view(), name='dashboard_noti_list'),

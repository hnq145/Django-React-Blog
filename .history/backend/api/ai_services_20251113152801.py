...
class AIServiceClient:
    """
    Lớp dịch vụ để giao tiếp với các mô hình AI (Gemini cho Text, Imagen cho Image).
    Mô hình được định nghĩa bởi thiết kế PATT (FR-AI-03, FR-AI-04).
    Sử dụng biến môi trường GEMINI_API_KEY (NFR-03).
    """
    def __init__(self):
        # NFR-03: Đảm bảo lấy API Key từ biến môi trường

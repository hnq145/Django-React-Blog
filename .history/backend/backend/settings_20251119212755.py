...
# --- CẤU HÌNH ĐỌC FILE .ENV (SỬA LỖI) ---
# Chỉ định rõ đường dẫn file .env nằm ở thư mục gốc (cùng cấp manage.py)
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', # CORS phải ở trên cùng
